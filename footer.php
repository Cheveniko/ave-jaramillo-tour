<footer class="bg-black">
	<div class="container py-8">
		<a href="https://foco-estudio.com" target="_blank" class="inline-block">
		<img
		...
		<div class="flex gap-x-4">
			<a href="https://www.instagram.com/elfocoestudio/" target="_blank">
			<i class="fa-brands fa-instagram text-[#e6e6e6] text-3xl"></i>
			</a>
			<a href="https://wa.me/593999848239" target="_blank">
			<i class="fa-brands fa-whatsapp text-[#e6e6e6] text-3xl"></i>
			</a>
		</div>
		<p class="text-white mt-8">&copy; 2024 Foco Producciones. Todos los derechos reservados.</p>
	</div>
</footer>
<?php wp_footer(); ?>
</body>
